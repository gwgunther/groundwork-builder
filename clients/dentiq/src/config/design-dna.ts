...
export const designDNA: DesignDNA = {
  ...
  "divergenceRationale": "Every recent own-build in the warm family used warm-editorial with asymmetric-right or full-bleed hero — this build adopts magazine-split with a split-image hero to introduce a two-column typographic rhythm that none of the prior builds have used. The dentiq slug itself was minimal-brutalist/text-only, so this candidate deliberately reintroduces photographic warmth through a structured editorial grid rather than stark type-only composition. The editorial-list services variant and thin-rule dividers reinforce the magazine DNA without tipping into the bold/cold editorial family.",
  "creativeDirection": "A neighborhood Houston practice rendered as a thoughtful editorial spread — deep forest teal grounds the two-column grid while warm gold accents thread through pull-quotes and divider rules, giving Dentiq the feel of a trusted local institution rather than a corporate dental chain.",
  "coverage": {
    "filteredSections": [
      {
  ...
  "writingTone": "Warm, clear, specific to Houston.",
  "brandSummary": "Dentiq Dentistry, serving Houston, — A neighborhood Houston practice rendered as a thoughtful editorial spread — deep forest teal grounds the two-column grid while warm gold accents thread through pull-quotes and divider rules, giving Dentiq the feel of a trusted local institution rather than a corporate dental chain.",
  "doRules": [
  ...
  "evalRationale": "Candidate 1's magazine-split archetype delivers the strongest layout variety and coherence — the split-offset hero, two-col-feature services, and single-featured review create genuine section rhythm without the centered-over-photo cliché (Candidate 0) or the repetition of the prior dentiq minimal-brutalist/text-only build (Candidate 2 retreads too close to that recent own-build despite the stated divergence). The editorial grid with teal/gold threading through pull-quotes and hairline rules reads as one intentional system, satisfying §A tenets 5, 6, and 7 most fully.",
