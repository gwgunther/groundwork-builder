...
export const designDNA: DesignDNA = {
  ...
  "radius": "md",
  "borrowedFrom": null,
  "borrowedTrait": "thin-rule section dividers between content blocks",
  "headingScale": "dramatic",
  "sectionDivider": "line",
  "heroTextPosition": "bottom-left",
  "divergenceRationale": "Every recent own-build in this family used warm-editorial with asymmetric-right hero — this build breaks from that by committing to editorial-asymmetric with a split-image hero, which creates a distinctly magazine-like two-column tension rather than the soft centered warmth of warm-editorial. The editorial-list services variant replaces the card-grid pattern that has appeared in every warm-editorial build, giving services a measured typographic rhythm instead of a repeated card motif. The featured-grid gallery and bordered-flat card treatment further separate this from the soft-shadow, rounded warmth of recent builds.",
  "creativeDirection": "A teal-and-gold editorial broadsheet — precise, considered, and unhurried — where Epilogue headings at dramatic scale anchor each section like a magazine spread, and thin horizontal rules give the layout the calm authority of a practice that doesn't need to shout.",
  "coverage": {
    "filteredSections": []
  },
  ...
  "writingTone": "Warm, clear, specific to Phoenix.",
  "brandSummary": "Arizona Biltmore Dentistry, led by Dr. Aaron Jeziorski, serving Phoenix, — A teal-and-gold editorial broadsheet — precise, considered, and unhurried — where Epilogue headings at dramatic scale anchor each section like a magazine spread, and thin horizontal rules give the layout the calm authority of a practice that doesn't need to shout.",
  "doRules": [
  ...
  "evalRationale": "Candidate 2 earns the win by combining the most coherent editorial system — split hero, alternating-row services, pull-quote reviews, and split-image CTA all reinforce a single magazine-broadsheet point of view — while the Epilogue + teal-gold palette with hairline rules avoids every hard-penalty cliché and delivers the strongest layout variety and anti-card restraint per §A tenets 5 and 6. Candidate 0's poster-hero is bold but the full-bleed typographic hero risks the centered-text-over-dark-photo penalty zone; Candidate 1 is nearly as strong but its list-testimonials swap weakens the pull-quote rhythm that makes Candidate 2's section set feel most unified.",
