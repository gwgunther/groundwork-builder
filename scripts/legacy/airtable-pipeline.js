/**
 * @deprecated Legacy Airtable CRM client — RETIRED June 2026.
 * Live pipeline + ops use scripts/pipeline/lib/d1.js (Cloudflare D1).
 * Kept only so migrate-airtable-* scripts and historical references resolve.
 * Do not import from new code.
 *
 * ---
 * Original notes below (API still works if env vars set; unused by live pipeline).
 *
 * Tables:
