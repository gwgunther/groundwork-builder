...
// Plain-English definitions shown as tooltips on checklist items.
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .scores-col-head.before { color: var(--red);   background: var(--red-bg);   border-left: 1px solid var(--line); text-align: center; text-decoration: none; }
    .scores-col-head.after  { color: var(--green); background: var(--green-bg); border-left: 1px solid var(--line); text-align: center; text-decoration: none; }
    ...
    /* Checklist item definitions / tooltips */
    .cl-def { font-size: 11px; color: var(--ink-soft); margin-top: 3px; font-weight: 400; font-style: italic; line-height: 1.45; }

    /* AI summary */
    .ai-summary { background: var(--accent-bg); border: 1px solid color-mix(in srgb, var(--accent) 30%, transparent); border-radius: 10px; padding: 20px 24px; margin: 0 0 32px; }
    ...
    @media (max-width: 560px) {
      ...
      .scores-inner { flex-direction: column; align-items: flex-start; }
    }
  </style>
</head>
<body>
...
function clRow(item) {
  ...
  // Look up definition — match on label prefix so "Site structure" matches even with extra text
